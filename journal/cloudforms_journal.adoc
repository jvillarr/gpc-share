...
| augpcpdrcfapp03.genpt.net | 10.5.50.98 |  255.255.255.0 | 10.5.50.1 | 10.5.152.5, 10.6.152.5 | CFME UI Appliance
| augpcpdrcfapp03.genpt.net | 10.5.50.99 |  255.255.255.0 | 10.5.50.1 | 10.5.152.5, 10.6.152.5 | CFME Worker Appliance
| augpcpdrcfapp02.genpt.net | 10.5.50.100 |  255.255.255.0 | 10.5.50.1 | 10.5.152.5, 10.6.152.5 | CFME Worker Appliance
| augpcpdrcfapp01.genpt.net | 10.5.128.217 |  255.255.254.0 | 10.5.128.1 | 10.5.152.5, 10.6.152.6 | CFME DB Appliance
|======================

.Storage Interface Configuration
[width="100%",options="header"]
|======================
| Host | IP Address | Netmask | Gateway | DNS Server
| zp11000.mcip.usmc.mil | 10.1.130.10 |  255.255.252.0 | none | none
| zp11001.mcip.usmc.mil | 10.1.130.11 |  255.255.252.0 | none | none
| zp11002.mcip.usmc.mil | 10.1.130.12 |  255.255.252.0 | none | none
| zp11003.mcip.usmc.mil | 10.1.130.13 |  255.255.252.0 | none | none
| zp11004.mcip.usmc.mil | 10.1.130.14 |  255.255.252.0 | none | none
| zp11005.mcip.usmc.mil | 10.1.130.15 |  255.255.252.0 | none | none
| zp11006.mcip.usmc.mil | 10.1.130.16 |  255.255.252.0 | none | none
| zp11007.mcip.usmc.mil | 10.1.130.17 |  255.255.252.0 | none | none
| zp11008.mcip.usmc.mil | 10.1.130.18 |  255.255.252.0 | none | none
| zp11009.mcip.usmc.mil | 10.1.130.19 |  255.255.252.0 | none | none
|======================
...
| DBRegion | 99     | Optional: When MCICOM decides to scale to have DB Replication
|======================
...
|==================================
| SMTP Server | 205.110.86.80
| email | mcicomcloud@mcip.usmc.mil
|==================================
...
| Bind Password: | <See MCICOM's Password list for this user>
|======
...
| Name | MCICOM VMW
| Type | VMware vCenter
| Host Name | cougar.mcip.usmc.mil
| IP Address | 10.1.100.146
| Zone | WK-Zone
| User | mcip\cf.cloud.svc
| Password | <See MCICOM Password List>
|=
...
| netapp02a | 10.2.100.19 | vsc.netapp.svc | <See MCICOM's Password List>
| netapp02b | 10.2.100.20 | vsc.netapp.svc | <See MCICOM's Password List>
| netapp03a | ??????????? | vsc.netapp.svc | <See MCICOM's Password List>
|======

==== NetApp Rapid Clone: Dialog_Storage_Controller Workflow

TODO: Will provide workflow when coding is complete

==== NetApp Rapid Clone: Dialog_VM_Sizing Workflow

TODO: Will provide workflow when coding is complete

==== NetApp Rapid Clone: Dialog_VM_Folder Workflow

TODO: Will provide workflow when coding is complete

==== NetApp Rapid Clone: Dialog_Clone_Source Workflow

TODO: Will provide workflow when coding is complete

==== NetApp Rapid Clone: Execute_Rapid_Clone Workflow
...
| servername | Attribute |  String | mcimgmt1.mcis.usmc.mil | | | [x] | | create | | | | | |
| username | Attribute |  String | MCIS\jose | | | [x] | | create | | | | | |
| password | Attribute |  Password | | | | [x] | | create | | | | | |
| controller_ip | Attribute |  String | 10.2.100.19 | | | [x] | | create | | | | | |
| controller_username | Attribute |  String | vsc.netapp.svc | | | [x] | | create | | | | | |
| controller_password | Attribute |  Password | | | | [x] | | create | | | | | |
...
[source,ruby]
----
include::../cloudforms/Datastore/MCICOM/Integration/RapidClone/Dialog_Storage_Controller.rb[Dialog_Storage_Controller]
----

===== Dialog_VM_Sizing
[source,ruby]
----
include::../cloudforms/Datastore/MCICOM/Integration/RapidClone/Dialog_VM_Sizing.rb[Dialog_VM_Sizing]
----

===== Execute_Rapid_Clone
[source,ruby]
----
include::../cloudforms/Datastore/MCICOM/Integration/RapidClone/Execute_Rapid_Clone.rb[Execute_Rapid_Clone]
----
...
=== Cloudforms: Appendix
==== Datastore Import File: link:../cloudforms/automate_backups/namespace_MCICOM.xml[namespace_MCICOM.xml]
[source,xml]
----
include::../cloudforms/automate_backups/namespace_MCICOM.xml[XML]
----
